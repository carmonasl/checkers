...
export class MsgClientImpl {
    ...
    PlayMove(request) {
        ...
        const promise = this.rpc.request('carmonasl.checkers.checkers.Msg', 'PlayMove', data);
        return promise.then((data) => MsgPlayMoveResponse.decode(new Reader(data)));
    }
    CreateGame(request) {
        const data = MsgCreateGame.encode(request).finish();
        const promise = this.rpc.request('carmonasl.checkers.checkers.Msg', 'CreateGame', data);
