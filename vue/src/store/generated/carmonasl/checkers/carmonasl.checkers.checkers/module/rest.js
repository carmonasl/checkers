...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/carmonasl/checkers/checkers/nextGame
         */
        this.queryNextGame = (params = {}) => this.request({
            path: `/carmonasl/checkers/checkers/nextGame`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/carmonasl/checkers/checkers/storedGame
         */
        this.queryStoredGameAll = (query, params = {}) => this.request({
            path: `/carmonasl/checkers/checkers/storedGame`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/carmonasl/checkers/checkers/storedGame/{index}
         */
        this.queryStoredGame = (index, params = {}) => this.request({
            path: `/carmonasl/checkers/checkers/storedGame/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
