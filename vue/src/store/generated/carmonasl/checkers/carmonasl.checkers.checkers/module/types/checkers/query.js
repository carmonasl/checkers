...
export const protobufPackage = 'carmonasl.checkers.checkers';
...
export class QueryClientImpl {
    ...
    StoredGame(request) {
        ...
        const promise = this.rpc.request('carmonasl.checkers.checkers.Query', 'StoredGame', data);
    ...
    StoredGameAll(request) {
        ...
        const promise = this.rpc.request('carmonasl.checkers.checkers.Query', 'StoredGameAll', data);
    ...
    NextGame(request) {
        ...
        const promise = this.rpc.request('carmonasl.checkers.checkers.Query', 'NextGame', data);
